      ...
      <div class="content-container">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div class="card card-hover text-center">
            ...
            <h3 class="text-lg font-semibold text-text-primary dark:text-text-primary-dark mb-2">{{ t('contact.github') }}</h3>
          ...
          <div class="card card-hover text-center">
            ...
            <h3 class="text-lg font-semibold text-text-primary dark:text-text-primary-dark mb-2">{{ t('contact.googleScholar') }}</h3>
        ...
        <div class="max-w-xl mx-auto">
          <div class="card">
            ...
            <form @submit.prevent="sendMessage" class="space-y-4">
              ...
              <div>
                <label for="email" class="block text-text-secondary dark:text-text-secondary-dark text-sm font-medium mb-2">{{ t('contact.email') }}</label>
                <input 
                  id="email"
                  v-model="form.email"
                  type="email" 
              ...
              <div>
                <label for="subject" class="block text-text-secondary dark:text-text-secondary-dark text-sm font-medium mb-2">{{ t('contact.subject') }}</label>
                <select 
                  id="subject"
                ...
                >
                  ...
                  <option value="teaching">{{ t('contact.teachingInquiry') }}</option>
